...
!
  namelist /init_pars/ &
      ...
      lcylinder_in_a_box, lsphere_in_a_box, llevitation_experiment_in_a_box, &
      llocal_iso, init_loops, lwrite_2d, lcylindrical_gravity, &
...
!
  namelist /run_pars/ &
      ...
      border_frac_x, border_frac_y, border_frac_z, lborder_hyper_diff, &
      lcylinder_in_a_box, lsphere_in_a_box, llevitation_experiment_in_a_box, ipencil_swap, &
...
!      
!  Levitation experiment in a box requires cylinder in a box
!
      if (llevitation_experiment_in_a_box) then
         if (.not. lcylinder_in_a_box) call stop_it_if_any(.true.,"levitation experiment in a box requires cylinder in a box")
      endif
!
